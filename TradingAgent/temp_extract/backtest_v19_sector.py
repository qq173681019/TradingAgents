...
# -*- coding: utf-8 -*-
"""
V17 - Robust Multi-Period Optimization (Anti-Overfitting)
...
def main():
    ...
    print("=" * 70)
    print("V19 - Sector-Focused Multi-Period Optimization")
    print("=" * 70)
    ...
    _tmp = os.path.join(SHARED_DATA_DIR, 'optuna_v19_best_params.json')
    ...
    success = v19_full_bi > v17_full_bi
    ...
    final = {
        ...
        'version': 'v19-sector-focused',
        'description': 'Sector-focused multi-period optimization (AI/chip/semiconductor/solar/power)',
        'training_periods': {
    ...
    fp = os.path.join(RESULT_DIR, 'backtest_v19_sector.json')
    ...
    params_path = os.path.join(SHARED_DATA_DIR, 'optuna_v19_best_params.json')

...
这是一个专门针对A股市场的智能分析GUI工具，支持单股分析和批量分析。
...
### 单股分析
1. 启动程序后，在界面中输入6位股票代码（如：688981）
2. 点击"开始分析"按钮
3. 等待分析完成，查看详细报告

### 批量分析
1. 点击"开始获取评分"进行所有股票的批量评分
2. 点击"CSV批量分析"导入CSV文件进行批量分析
3. 准备CSV文件格式：第一列为股票代码，第一行为标题
4. 分析结果自动保存为新的CSV文件
...
- 科创板：688开头（如：688981 中芯国际）
- 主板：600开头（如：600519 贵州茅台）  
- 深市：000开头（如：000002 万科A）

    ...
    if config["llm_provider"] == "deepseek":
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                {
                    "role": "user", 
                    "content": f"Search social media for {query} from {start_date} to {end_date}."
                }
            ],
            temperature=1,
            max_tokens=4096,
    ...
    if config["llm_provider"] == "deepseek":
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                {
                    "role": "user", 
                    "content": f"Search for global macroeconomic news from {look_back_days} days before {curr_date} to {curr_date}."
                }
            ],
            temperature=1,
            max_tokens=4096,
    ...
    if config["llm_provider"] == "deepseek":
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                {
                    "role": "user", 
                    "content": f"Search for fundamental data on {ticker} as of {curr_date}."
                }
            ],
            temperature=1,
            max_tokens=4096,
